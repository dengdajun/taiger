    ...
    <div class="main clear">
        <div class="nav-bar">
            <ul class="bar1">
                ...
                <li class="bar1-li"><a href="${ctx}/system/tiger/videos">思科课程试听 <i class="icon-angle-right"></i></a> </li>
                <li class="active bar1-li"><a href="${ctx}/system/tiger/videos-huawei">华为课程试听  <i class="icon-angle-right"></i></a>  </li>
            </ul>
            <ul class="bar2">
        ...
        <div class="right-con">
            ...
            <div id="article3" class="new-class">
                ...
                <div class="videos clear">
                    ...
                    <div class="audio-visual">
                        <video  autoplay="true" controls="controls" loop="true" >
                            <source src="${ctx}/static/video/BigBuckBunny_640x360.mp4" type="video/mp4"/>
                ...
                <script src="${ctx}/static/js/page-img.js"></script>        <!-- 必须放这里 -->
            </div>
