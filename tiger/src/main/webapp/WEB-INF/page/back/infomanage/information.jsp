			...
			<div class="modal-content">
				...
				<div class="modal-body" style="max-height: 500px;overflow-y: scroll;">
					...
					<div class="blue clearfix">
						...
						<input type="text" id="date" class="width-100" />
					</div>
					...
					<div class="blue clearfix">
						...
						<input type="file" id="photo" class="width-100" onchange="previewFile(this)" />
						<img src="" id="img" class="width-100" />
					</div>
				</div>
        ...
        $(".page-content-area").ace_ajax("loadScripts", scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/admin/news/getBattlefield",
        			datatype : "json",
        			height : 450,
        			colNames : ["ID", "标题", "发布时间", "正文"],
        			colModel : [ {
        				name : "id",
        				index : "id",
        				label : "ID",
        			...
        			editurl : "${contextPath}/admin/news/editData"
        			//caption : "用户管理列表",
        			//autowidth : true,
        			/**
        			grouping : true, 
        		...
        		$("#editInformationButton").bind("click", function() {
        			...
        			if(null == selectedId){
        				...
        				$("#date").val(jQuery(grid_selector).jqGrid("getRowData",jQuery(grid_selector).jqGrid("getGridParam", "selrow")).date);
        				$("#editor").html(jQuery(grid_selector).jqGrid("getRowData",jQuery(grid_selector).jqGrid("getGridParam", "selrow")).content);
						$("#photo").val(jQuery(grid_selector).jqGrid("getRowData",jQuery(grid_selector).jqGrid("getGridParam", "selrow")).photo);
        			}
        		});
        		...
        		$("#informationForm").on("submit", function(e) {
        			if ($("#title").val() == "") {
    			    	...
    			    	$.ajax({
            				dataType : "json",
            				url : "${contextPath}/admin/news/editData?oper=edit",
            				type : "post",
            				data : {
            					id : $("#id").val(),
            					title : $("#title").val(),
