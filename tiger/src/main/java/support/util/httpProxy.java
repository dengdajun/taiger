...
//  static public String LOGFILENAME_C="log_C.txt";
    ...
    static public void main(String args[]) throws FileNotFoundException {
        System.out.println("在端口8088启动代理服务器\n");
        OutputStream file_S=new FileOutputStream(new File("foc"));
        OutputStream file_C=new FileOutputStream(new File("fos"));
