        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/taige/openclsss/getclass",
        			datatype : "json",
        			height : 450,
				colNames : ['', 'ID', '内容', '时间'],
        			colModel : [ {
        				...
        				editable : true,
						edittype : "textarea",
        				editoptions : {size : "225", maxlength : "225"},
        			...
        			editurl : "${contextPath}/taige/openclsss/operateClass"
        			//caption : "用户管理列表",
        			//autowidth : true,
        			/**
        			grouping : true, 
        		...
        		if(<shiro:hasPermission name="${ROLE_KEY}:sysuser:export">true</shiro:hasPermission><shiro:lacksPermission name="${ROLE_KEY}:sysuser:export">false</shiro:lacksPermission>){
    				jQuery(grid_selector).jqGrid('navButtonAdd', pager_selector,{
   				       ...
   				       onClickButton : function () { 
   				    	   ...
   				    	   var form = "<form name='csvexportform' action='${contextPath}/taige/openclsss/operateClass?oper=excel' method='post'>";
