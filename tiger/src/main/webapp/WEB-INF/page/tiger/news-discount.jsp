...
<div class="main places">当前位置：首页>新闻资讯>最新优惠</div>
<!--内容-->
<div class="content">
    <div class="main clear">
        <div class="nav-bar">
            <ul class="bar1">
                ...
                <li class="bar1-li"><a href="${ctx}/system/tiger/news">最新开班  <i class="icon-angle-right"></i></a>  </li>
                <li class="bar1-li active"><a href="${ctx}/system/tiger/news-discount">最新优惠  <i class="icon-angle-right"></i></a>  </li>
            </ul>
            <ul class="bar2">
        ...
        <div class="right-con">
            ...
            <div id="article3" class="new-class">
                <h2 style="margin-bottom: 0">最新优惠</h2>
                <c:forEach items="${discount}" var="n">
                    <div class="curriculum news-curriculum">
                        ...
                        <div class="clear">
                            <p> <b class="clear">${n.content}</b>
                               <span class="all">...查看全文<b style="display:none;" id="nid">${n.nid}</b><strong style="display:none;">${n.ntype}</strong></span>
                            </p>

                            <img src="${ctx}/static/img/NEWS-dis.png" alt=""/>
                        </div>
                    </div>
                </c:forEach>
